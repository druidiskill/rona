...
class DatabaseManager:
    ...
    async def _create_tables(self, db: aiosqlite.Connection):
        ...
        await db.execute(
            """
            CREATE TABLE IF NOT EXISTS calendar_cache_meta (
        ...
        await db.execute(
            """
            CREATE INDEX IF NOT EXISTS idx_calendar_events_cache_calendar_start
            ON calendar_events_cache(calendar_id, start_time)
            """
        )
