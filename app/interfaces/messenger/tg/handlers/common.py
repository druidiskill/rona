...
from app.interfaces.messenger.tg.states import SupportStates
from app.integrations.local.db import admin_repo, support_repo, faq_repo
from app.core.modules.support.common import (
    build_faq_list_text,
    get_faq_page_data,
    truncate_question,
)
from app.core.modules.support.use_case import prepare_telegram_support_request
from app.interfaces.messenger.tg.services.support_notifications import send_support_request_to_telegram_admins
