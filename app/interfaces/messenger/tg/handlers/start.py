...
async def main_menu_callback(callback: CallbackQuery, state: FSMContext, is_admin: bool = False):
    ...
    if callback.data == "admin_panel":
        if is_admin:
            from app.interfaces.messenger.tg.handlers.admin import admin_panel
...
async def help_command(message: Message):
    ...
    from app.interfaces.messenger.tg.handlers.common import send_faq_list_message
    await send_faq_list_message(message, page=0)
