...
from app.integrations.local.db import admin_repo, faq_repo, support_repo
from app.core.modules.support.common import (
    build_faq_list_text,
    get_faq_page_data,
    truncate_question,
)
from app.core.modules.support.use_case import prepare_vk_support_request
from app.interfaces.messenger.vk.auth import is_vk_admin_id
from app.interfaces.messenger.vk.services.support_notifications import send_support_request_to_vk_admins
